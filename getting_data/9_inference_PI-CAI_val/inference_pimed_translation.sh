...
#SBATCH --container-mounts=/data/pelvis/projects/tiago/DWI_IQA/validation_procanceri_100:/dataset:ro,/data/pelvis/projects/tiago/DWI_IQA/validation_procanceri_100/Pimed:/results
#SBATCH --container-image="doduo1.umcn.nl#joeran/picai_pimed_inference_docker_batched:v1.5"
