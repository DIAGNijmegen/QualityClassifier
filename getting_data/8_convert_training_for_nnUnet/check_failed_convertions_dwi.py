...
find_missing_files_with_hospital_and_name(
    task_folder='/Volumes/pelvis/projects/tiago/DWI_IQA/data_DWI/raw/nnUnet_raw_data/Task001_ProstateQualityDWI',
    hq_file='../5_get_hq_dwi_lists/hq_dwi_final_50_50.json',
    lq_file='../4_get_lq_dwi_lists/lq_dwi_final.json'
)
